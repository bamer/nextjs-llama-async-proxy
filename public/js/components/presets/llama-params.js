...
const PARAM_GROUPS = {
  core: { label: "Core", icon: "⚙️", order: 1 },
  hardware: { label: "Hardware", icon: "🔧", order: 2 },
  sampling: { label: "Sampling", icon: "🎲", order: 3 },
  behavior: { label: "Behavior", icon: "🧠", order: 4 },
  context: { label: "Context", icon: "📝", order: 5 },
  performance: { label: "Performance", icon: "🚀", order: 6 },
  speculative: { label: "Speculative", icon: "🔮", order: 7 },
  model: { label: "Model", icon: "📦", order: 8 },
};
