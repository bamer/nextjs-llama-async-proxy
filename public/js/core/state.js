...
class StateManager {
  ...
  _setupSocket() {
    ...
    this.socket.on("connect", () => {
      console.log("[StateManager] Connected, sending ack...");
    ...
    const responseEvents = [
      ...
      "models:stop:result", "metrics:get:result", "metrics:history:result",
  ...
  async updateModel(id, u) { return this.request("models:update", { modelId: id, updates: u }); }
