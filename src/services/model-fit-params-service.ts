...
import type { ModelFitParams } from "../lib/database/models/ModelConfig.types";

/**
 * Saves model fit parameters to the database
 * @param modelId - The model ID
 * @param fitParams - The fit parameters to save
...
/**
 * Retrieves model fit parameters from the database
 * @param modelId - The model ID
 * @returns The fit parameters or null if not found
 */
...
/**
 * Determines if fit parameters should be reanalyzed based on file modification time
 * @param modelId - The model ID
 * @param modelPath - The path to the model file
 * @returns True if reanalysis is needed, false otherwise
 */
