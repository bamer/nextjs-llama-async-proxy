...
const LLAMA_PARAMS = [
  ...
  {
    key: "thinking-forced-open",
    iniKey: "thinkingForcedOpen",
  ...
  },
  {
    ...
    options: ["off", "on"],
    group: "performance",
    description: "Perform warmup run on model startup",
  },
];
