...
import { importDatabaseData } from "./import-data";
import { clearAllTables } from "./cleanup";
 ...
 */
export { vacuumDatabase } from "./optimization";
...
export function importDatabase(
  ...
  try {
    importDatabaseData(actualDb, actualPath);
