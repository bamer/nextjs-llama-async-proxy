...
describe("LlamaDefaults - Unit Tests", () => {
  ...
  describe("Sampling Parameters", () => {
    ...
    it("should have dry_sequence_breaker", () => {
      ...
      expect(typeof DEFAULT_LLAMA_SERVER_CONFIG.dry_sequence_breaker).toBe(
        "string"
      );
    });
  });
  ...
  describe("Additional Options", () => {
    ...
    it("should have neg_prompt_multiplier", () => {
      ...
      expect(typeof DEFAULT_LLAMA_SERVER_CONFIG.neg_prompt_multiplier).toBe(
        "number"
      );
    });
