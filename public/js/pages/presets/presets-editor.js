...
(function() {
  ...
  function extendPresetsPage() {
    ...
    /**
     * Handle changes to preset parameters.
    ...
    /**
     * Delete a parameter from the preset.
     * @param {string} paramKey - The parameter key to delete.
     * @returns {Promise<void>}
     */
    ...
    /**
     * Delete a model-specific parameter.
     * @param {string} paramKey - The parameter key to delete.
     ...
     * @param {Object} data - The parameter data.
     * @param {string} data.paramKey - The parameter key.
     * @param {string} data.modelName - The model name.
     * @returns {Promise<void>}
     */
    ...
    /**
     * Delete a model from the preset.
    ...
    console.log("[PRESETS] PresetsPage extended with editor methods");
  }
